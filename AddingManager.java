...
public class AddingManager extends JFrame{
	String Id;
	String name;
	String phoneNumber;
	String registerNo;
	...
	AddingManager(){
		...
		add(password_t1);
		JButton b = new JButton("Submit Mangaer Details");
		add(b); 
		b.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				System.out.println("y");
				Manager obj = new Manager();
				Users u=new Users(Id_t1.getText(),name_t1.getText(),phoneNumber_t1.getText(),registerNo_t1.getText(),email_Id_t1.getText(),password_t1.getText(),"manager");
				obj.addEmployee(u);
			}
