...
public class AddingEmployees extends JFrame{
	AddingEmployees(){
		...
		add(password_t1);
		JButton b = new JButton("Submit Employee Details");
		add(b);
		b.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				System.out.println("y");
				Manager obj = new Manager();
				Users u = new Users(Id_t1.getText(),name_t1.getText(),phoneNumber_t1.getText(),registerNo_t1.getText(),email_Id_t1.getText(),password_t1.getText(),"employee");
				obj.addEmployee(u);
			}
